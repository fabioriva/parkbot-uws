...
const al07 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 7)
const al08 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 8)
const al09 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 9)
const al10 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 10)
const al11 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 11)
const al12 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 12)
const al13 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 13)
const al14 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 14)
const al15 = new Alarms(generateAlarms(1, 64, str.ALARMS.slice(64, 128)), 15)
