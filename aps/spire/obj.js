...
const al04 = new Alarms(generateAlarms(4, 1, 64, str.alarms1), 'IVT1')
const al05 = new Alarms(generateAlarms(5, 1, 64, str.alarms1), 'IVT2')
const al06 = new Alarms(generateAlarms(6, 1, 64, str.alarms1), 'IVT3')
...
const inputs5 = generateBits('E', 210, 212, str.inputs5)
const inputs6 = generateBits('E', 300, 307, str.inputs6)
const inputs7 = generateBits('E', 310, 312, str.inputs7)
...
const inputs11 = generateBits('E', 500, 503, str.inputs11)
const inputs12 = generateBits('E', 504, 505, str.inputs12)
const inputs13 = generateBits('E', 510, 514, str.inputs13)
const inputs14 = generateBits('E', 600, 603, str.inputs14)
const inputs15 = generateBits('E', 604, 605, str.inputs15)
const inputs16 = generateBits('E', 610, 614, str.inputs16)
...
const outputs4 = generateBits('A', 200, 203, str.outputs4)
const outputs5 = generateBits('A', 210, 211, str.outputs5)
const outputs6 = generateBits('A', 300, 303, str.outputs6)
const outputs7 = generateBits('A', 310, 311, str.outputs7)
...
const outputs11 = generateBits('A', 500, 501, str.outputs11)
const outputs12 = generateBits('A', 504, 504, str.outputs12)
const outputs13 = generateBits('A', 510, 512, str.outputs13)
const outputs14 = generateBits('A', 600, 601, str.outputs14)
const outputs15 = generateBits('A', 604, 604, str.outputs15)
const outputs16 = generateBits('A', 610, 612, str.outputs16)
